...
function addItem(req, res, next) {
    ...
    getPointBalance(userId)
        .then(function(result) {
            ...
            db.query('INSERT INTO salesforce1.interaction__c (loyaltyid__c, campaign__c, product__c, type__c, points__c, name__c, picture__c) VALUES ($1, $2, $3, $4, $5, $6, $7)',
...
function getItems(req, res, next) {
    ...
    db.query("SELECT LoyaltyId__c AS userId, campaign__c AS campaign, type__c AS type, name__c as name, picture__c as picture, points__c as points, createdDate FROM salesforce1.interaction__c WHERE LoyaltyId__c=$1 ORDER BY id DESC LIMIT 20", [externalUserId])
...
function deleteItems(userId) {
    ...
    return db.query("DELETE FROM salesforce1.interaction__c WHERE LoyaltyId__c=$1", [userId]);
}
...
function getPointBalance(userId) {
    return db.query('select sum(points__c) as points from salesforce1.interaction__c where loyaltyid__c=$1', [userId], true);
}
